...
extern "C" {
#endif
void OSVRRP0InBra_aB_p100__0__d__1___TwoPRep_s__0__s010__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5) {
...
fp53 = fp54 * src5[((hsi*6+0)*1+lsi)*1];
...
fp46 = fp54 * src5[((hsi*6+1)*1+lsi)*1];
LIBINT2_REALTYPE fp48;
fp48 = fp99 * src2[((hsi*3+0)*1+lsi)*1];
...
fp41 = fp54 * src5[((hsi*6+2)*1+lsi)*1];
...
fp28 = fp54 * src5[((hsi*6+4)*1+lsi)*1];
...
fp23 = fp54 * src5[((hsi*6+5)*1+lsi)*1];
...
fp34 = fp54 * src5[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp36;
fp36 = fp110 * src2[((hsi*3+1)*1+lsi)*1];
