...
fp65 = inteval->PB_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp74 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp78 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp85 = inteval->PB_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
