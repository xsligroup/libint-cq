...
extern "C" {
#endif
void HRRPart0bra0ket0dp020(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp43 = 2.0000000000000000e+00 * src2[((hsi*6+0)*lowdim+lsi)*1];
...
fp35 = 2.0000000000000000e+00 * src2[((hsi*6+1)*lowdim+lsi)*1];
...
fp27 = 2.0000000000000000e+00 * src2[((hsi*6+2)*lowdim+lsi)*1];
...
fp19 = 2.0000000000000000e+00 * src2[((hsi*6+3)*lowdim+lsi)*1];
...
fp11 = 2.0000000000000000e+00 * src2[((hsi*6+4)*lowdim+lsi)*1];
...
fp3 = 2.0000000000000000e+00 * src2[((hsi*6+5)*lowdim+lsi)*1];
