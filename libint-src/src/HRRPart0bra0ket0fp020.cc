...
extern "C" {
#endif
void HRRPart0bra0ket0fp020(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp75 = 2.0000000000000000e+00 * src2[((hsi*10+0)*lowdim+lsi)*1];
...
fp72 = src0[((hsi*15+2)*lowdim+lsi)*1] + fp73;
...
fp67 = 2.0000000000000000e+00 * src2[((hsi*10+1)*lowdim+lsi)*1];
...
fp64 = src0[((hsi*15+4)*lowdim+lsi)*1] + fp65;
...
fp59 = 2.0000000000000000e+00 * src2[((hsi*10+2)*lowdim+lsi)*1];
...
fp51 = 2.0000000000000000e+00 * src2[((hsi*10+3)*lowdim+lsi)*1];
...
fp48 = src0[((hsi*15+7)*lowdim+lsi)*1] + fp49;
...
fp43 = 2.0000000000000000e+00 * src2[((hsi*10+4)*lowdim+lsi)*1];
...
fp40 = src0[((hsi*15+8)*lowdim+lsi)*1] + fp41;
...
fp35 = 2.0000000000000000e+00 * src2[((hsi*10+5)*lowdim+lsi)*1];
...
fp27 = 2.0000000000000000e+00 * src2[((hsi*10+6)*lowdim+lsi)*1];
...
fp19 = 2.0000000000000000e+00 * src2[((hsi*10+7)*lowdim+lsi)*1];
...
fp11 = 2.0000000000000000e+00 * src2[((hsi*10+8)*lowdim+lsi)*1];
...
fp3 = 2.0000000000000000e+00 * src2[((hsi*10+9)*lowdim+lsi)*1];
