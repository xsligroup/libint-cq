...
fp65 = inteval->PA_y[vi] * target[((hsi*16+2)*1+lsi)*1];
LIBINT2_REALTYPE fp62;
fp62 = fp65 + fp63;
target[((hsi*16+4)*1+lsi)*1] = fp62;
LIBINT2_REALTYPE fp54;
fp54 = inteval->PA_y[vi] * target[((hsi*16+4)*1+lsi)*1];
...
fp43 = inteval->PA_y[vi] * target[((hsi*16+6)*1+lsi)*1];
LIBINT2_REALTYPE fp40;
fp40 = fp43 + fp41;
target[((hsi*16+8)*1+lsi)*1] = fp40;
LIBINT2_REALTYPE fp32;
fp32 = inteval->PA_y[vi] * target[((hsi*16+8)*1+lsi)*1];
...
fp21 = inteval->PA_y[vi] * target[((hsi*16+10)*1+lsi)*1];
...
fp69 = inteval->PA_y[vi] * target[((hsi*16+1)*1+lsi)*1];
...
fp61 = inteval->PA_y[vi] * target[((hsi*16+3)*1+lsi)*1];
...
fp50 = inteval->PA_y[vi] * target[((hsi*16+5)*1+lsi)*1];
...
fp39 = inteval->PA_y[vi] * target[((hsi*16+7)*1+lsi)*1];
...
fp28 = inteval->PA_y[vi] * target[((hsi*16+9)*1+lsi)*1];
...
fp17 = inteval->PA_y[vi] * target[((hsi*16+11)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*16+13)*1+lsi)*1];
...
fp10 = inteval->PA_y[vi] * target[((hsi*16+12)*1+lsi)*1];
