...
fp53 = inteval->PB_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp57 = inteval->PB_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp62 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp66 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
