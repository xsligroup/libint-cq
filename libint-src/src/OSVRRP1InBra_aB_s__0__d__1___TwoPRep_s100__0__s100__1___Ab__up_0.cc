...
extern "C" {
#endif
void OSVRRP1InBra_aB_s__0__d__1___TwoPRep_s100__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5, const LIBINT2_REALTYPE* src6) {
...
fp20 = inteval->alpha4_rho_over_eta2[vi] * src6[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp21;
fp21 = inteval->rho34_over_alpha3[vi] * src5[((hsi*3+0)*1+lsi)*1];
