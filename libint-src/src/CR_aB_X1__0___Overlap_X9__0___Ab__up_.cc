...
fp68 = inteval->PB_x[vi] * target[((hsi*20+1)*1+lsi)*1];
...
fp64 = inteval->PB_x[vi] * target[((hsi*20+2)*1+lsi)*1];
...
fp60 = inteval->PB_x[vi] * target[((hsi*20+3)*1+lsi)*1];
...
fp56 = inteval->PB_x[vi] * target[((hsi*20+4)*1+lsi)*1];
...
fp52 = inteval->PB_x[vi] * target[((hsi*20+5)*1+lsi)*1];
...
fp48 = inteval->PB_x[vi] * target[((hsi*20+6)*1+lsi)*1];
...
fp44 = inteval->PB_x[vi] * target[((hsi*20+7)*1+lsi)*1];
...
fp40 = inteval->PB_x[vi] * target[((hsi*20+8)*1+lsi)*1];
...
fp35 = inteval->PA_x[vi] * target[((hsi*20+1)*1+lsi)*1];
...
fp31 = inteval->PA_x[vi] * target[((hsi*20+2)*1+lsi)*1];
...
fp27 = inteval->PA_x[vi] * target[((hsi*20+3)*1+lsi)*1];
...
fp23 = inteval->PA_x[vi] * target[((hsi*20+4)*1+lsi)*1];
...
fp19 = inteval->PA_x[vi] * target[((hsi*20+5)*1+lsi)*1];
...
fp15 = inteval->PA_x[vi] * target[((hsi*20+6)*1+lsi)*1];
...
fp11 = inteval->PA_x[vi] * target[((hsi*20+7)*1+lsi)*1];
...
fp7 = inteval->PA_x[vi] * target[((hsi*20+8)*1+lsi)*1];
...
fp3 = inteval->PA_x[vi] * target[((hsi*20+9)*1+lsi)*1];
