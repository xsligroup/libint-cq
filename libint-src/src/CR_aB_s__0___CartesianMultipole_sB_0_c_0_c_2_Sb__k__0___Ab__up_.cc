...
fp25 = 0.0000000000000000e+00 + src2[((hsi*10+4)*1+lsi)*1];
...
fp48 = 0.0000000000000000e+00 + src1[((hsi*10+3)*1+lsi)*1];
...
fp47 = 0.0000000000000000e+00 + src1[((hsi*10+4)*1+lsi)*1];
...
fp20 = 0.0000000000000000e+00 + src2[((hsi*10+5)*1+lsi)*1];
...
fp50 = 0.0000000000000000e+00 + src1[((hsi*10+1)*1+lsi)*1];
...
fp49 = 0.0000000000000000e+00 + src1[((hsi*10+2)*1+lsi)*1];
