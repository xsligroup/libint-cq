...
extern "C" {
#endif
void OSVRRP0InBra_aB_p002__0__d__1___TwoPRep_unit__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp36 = inteval->oo2ze[vi] * src1[((hsi*3+0)*1+lsi)*1];
...
fp16 = 2.0000000000000000e+00 * fp17;
...
fp32 = fp50 * src1[((hsi*3+1)*1+lsi)*1];
