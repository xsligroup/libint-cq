...
fp57 = inteval->PB_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp61 = inteval->PB_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp68 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp72 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp69;
fp69 = fp72 + fp70;
target[((hsi*15+2)*1+lsi)*1] = fp69;
LIBINT2_REALTYPE fp76;
fp76 = -5.0000000000000000e-01 * src3[((hsi*10+0)*1+lsi)*1];
