...
extern "C" {
#endif
void OSVRRP1InBra_aB_s101__0__g__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp38 = fp39 * src4[((hsi*10+5)*1+lsi)*1];
...
fp47 = fp48 * src4[((hsi*10+4)*1+lsi)*1];
...
fp56 = fp57 * src4[((hsi*10+3)*1+lsi)*1];
...
fp67 = 1.0000000000000000e+00 * inteval->alpha1_over_zetapluseta[vi];
LIBINT2_REALTYPE fp66;
fp66 = fp67 * src4[((hsi*10+2)*1+lsi)*1];
...
fp75 = fp76 * src4[((hsi*10+1)*1+lsi)*1];
...
fp85 = fp86 * src4[((hsi*10+0)*1+lsi)*1];
...
fp90 = fp91 * src3[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp95;
fp95 = inteval->roe[vi] * src2[((hsi*6+0)*1+lsi)*1];
LIBINT2_REALTYPE fp94;
fp94 = src1[((hsi*6+0)*1+lsi)*1] - fp95;
LIBINT2_REALTYPE fp96;
fp96 = 3.0000000000000000e+00 * inteval->oo2e[vi];
LIBINT2_REALTYPE fp93;
fp93 = fp96 * fp94;
LIBINT2_REALTYPE fp97;
fp97 = inteval->WQ_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
