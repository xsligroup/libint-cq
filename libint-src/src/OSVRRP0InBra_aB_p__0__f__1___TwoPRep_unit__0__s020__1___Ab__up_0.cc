...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_unit__0__s020__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp33 = fp81 * src1[((hsi*6+3)*1+lsi)*1];
...
fp28 = fp77 * src1[((hsi*6+4)*1+lsi)*1];
