...
extern "C" {
#endif
void OSVRRP1InBra_aB_s020__0__d__1___TwoPRep_unit__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp18 = 2.0000000000000000e+00 * inteval->alpha1_over_zetapluseta[vi];
LIBINT2_REALTYPE fp8;
fp8 = fp18 * src4[((hsi*3+1)*1+lsi)*1];
...
fp17 = fp18 * src4[((hsi*3+0)*1+lsi)*1];
...
fp27 = inteval->WQ_x[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp28;
fp28 = inteval->QC_x[vi] * src0[((hsi*3+0)*1+lsi)*1];
