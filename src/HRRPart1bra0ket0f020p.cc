...
extern "C" {
#endif
void HRRPart1bra0ket0f020p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp75 = 2.0000000000000000e+00 * src2[((hsi*10+0)*1+lsi)*1];
...
fp67 = 2.0000000000000000e+00 * src2[((hsi*10+1)*1+lsi)*1];
...
fp59 = 2.0000000000000000e+00 * src2[((hsi*10+2)*1+lsi)*1];
...
fp51 = 2.0000000000000000e+00 * src2[((hsi*10+3)*1+lsi)*1];
...
fp43 = 2.0000000000000000e+00 * src2[((hsi*10+4)*1+lsi)*1];
...
fp35 = 2.0000000000000000e+00 * src2[((hsi*10+5)*1+lsi)*1];
...
fp27 = 2.0000000000000000e+00 * src2[((hsi*10+6)*1+lsi)*1];
...
fp19 = 2.0000000000000000e+00 * src2[((hsi*10+7)*1+lsi)*1];
...
fp11 = 2.0000000000000000e+00 * src2[((hsi*10+8)*1+lsi)*1];
...
fp3 = 2.0000000000000000e+00 * src2[((hsi*10+9)*1+lsi)*1];
