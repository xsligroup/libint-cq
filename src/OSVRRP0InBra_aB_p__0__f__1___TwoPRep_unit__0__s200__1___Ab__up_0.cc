...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_unit__0__s200__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp78 = 2.0000000000000000e+00 * inteval->alpha4_over_zetapluseta[vi];
LIBINT2_REALTYPE fp71;
fp71 = fp78 * src2[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp74;
fp74 = 2.0000000000000000e+00 * inteval->oo2ze[vi];
LIBINT2_REALTYPE fp73;
fp73 = fp74 * src1[((hsi*6+1)*1+lsi)*1];
LIBINT2_REALTYPE fp75;
fp75 = inteval->WP_x[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp66 = fp78 * src2[((hsi*10+2)*1+lsi)*1];
LIBINT2_REALTYPE fp68;
fp68 = fp74 * src1[((hsi*6+2)*1+lsi)*1];
...
fp65 = fp67 + fp66;
target[((hsi*30+2)*1+lsi)*1] = fp65;
LIBINT2_REALTYPE fp61;
fp61 = fp78 * src2[((hsi*10+3)*1+lsi)*1];
LIBINT2_REALTYPE fp63;
fp63 = inteval->oo2ze[vi] * src1[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp64;
fp64 = inteval->WP_x[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp56 = fp78 * src2[((hsi*10+4)*1+lsi)*1];
...
fp51 = fp78 * src2[((hsi*10+5)*1+lsi)*1];
LIBINT2_REALTYPE fp53;
fp53 = inteval->oo2ze[vi] * src1[((hsi*6+5)*1+lsi)*1];
...
fp48 = fp78 * src2[((hsi*10+6)*1+lsi)*1];
...
fp45 = fp78 * src2[((hsi*10+7)*1+lsi)*1];
...
fp42 = fp78 * src2[((hsi*10+8)*1+lsi)*1];
...
fp39 = fp78 * src2[((hsi*10+9)*1+lsi)*1];
...
fp80 = fp81 * src1[((hsi*6+0)*1+lsi)*1];
LIBINT2_REALTYPE fp82;
fp82 = inteval->WP_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp25 = fp81 * src1[((hsi*6+3)*1+lsi)*1];
...
fp22 = fp74 * src1[((hsi*6+4)*1+lsi)*1];
