...
extern "C" {
#endif
void CR_DerivGaussP0InBra_aB_h010__0__s__1___TwoPRep_unit__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
...
fp12 = inteval->two_alpha0_bra[vi] * src0[((hsi*28+22)*1+lsi)*1];
...
fp9 = inteval->two_alpha0_bra[vi] * src0[((hsi*28+23)*1+lsi)*1];
...
fp6 = inteval->two_alpha0_bra[vi] * src0[((hsi*28+24)*1+lsi)*1];
...
fp3 = inteval->two_alpha0_bra[vi] * src0[((hsi*28+25)*1+lsi)*1];
