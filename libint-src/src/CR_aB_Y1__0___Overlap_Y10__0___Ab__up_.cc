...
fp76 = inteval->PB_y[vi] * target[((hsi*22+1)*1+lsi)*1];
...
fp72 = inteval->PB_y[vi] * target[((hsi*22+2)*1+lsi)*1];
...
fp68 = inteval->PB_y[vi] * target[((hsi*22+3)*1+lsi)*1];
...
fp64 = inteval->PB_y[vi] * target[((hsi*22+4)*1+lsi)*1];
...
fp60 = inteval->PB_y[vi] * target[((hsi*22+5)*1+lsi)*1];
...
fp56 = inteval->PB_y[vi] * target[((hsi*22+6)*1+lsi)*1];
...
fp52 = inteval->PB_y[vi] * target[((hsi*22+7)*1+lsi)*1];
...
fp48 = inteval->PB_y[vi] * target[((hsi*22+8)*1+lsi)*1];
...
fp44 = inteval->PB_y[vi] * target[((hsi*22+9)*1+lsi)*1];
...
fp39 = inteval->PA_y[vi] * target[((hsi*22+1)*1+lsi)*1];
...
fp35 = inteval->PA_y[vi] * target[((hsi*22+2)*1+lsi)*1];
...
fp31 = inteval->PA_y[vi] * target[((hsi*22+3)*1+lsi)*1];
...
fp27 = inteval->PA_y[vi] * target[((hsi*22+4)*1+lsi)*1];
...
fp23 = inteval->PA_y[vi] * target[((hsi*22+5)*1+lsi)*1];
...
fp19 = inteval->PA_y[vi] * target[((hsi*22+6)*1+lsi)*1];
...
fp15 = inteval->PA_y[vi] * target[((hsi*22+7)*1+lsi)*1];
...
fp11 = inteval->PA_y[vi] * target[((hsi*22+8)*1+lsi)*1];
...
fp7 = inteval->PA_y[vi] * target[((hsi*22+9)*1+lsi)*1];
...
fp3 = inteval->PA_y[vi] * target[((hsi*22+10)*1+lsi)*1];
