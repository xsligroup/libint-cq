...
fp86 = -5.0000000000000000e-01 * src2[((hsi*15+0)*1+lsi)*1];
LIBINT2_REALTYPE fp85;
fp85 = 0.0000000000000000e+00 + fp86;
LIBINT2_REALTYPE fp84;
fp84 = inteval->oo2z[vi] * fp85;
LIBINT2_REALTYPE fp87;
fp87 = inteval->PA_y[vi] * src0[((hsi*15+0)*1+lsi)*1];
...
fp81 = inteval->PA_y[vi] * src0[((hsi*15+1)*1+lsi)*1];
...
fp73 = inteval->PA_z[vi] * src0[((hsi*15+2)*1+lsi)*1];
...
fp68 = inteval->PA_y[vi] * src0[((hsi*15+3)*1+lsi)*1];
...
fp55 = inteval->PA_z[vi] * src0[((hsi*15+5)*1+lsi)*1];
...
fp27 = inteval->PA_y[vi] * src0[((hsi*15+10)*1+lsi)*1];
...
fp50 = inteval->PA_y[vi] * src0[((hsi*15+6)*1+lsi)*1];
