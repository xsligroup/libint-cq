...
extern "C" {
#endif
void HRRPart0bra0ket0d200p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp37 = 2.0000000000000000e+00 * src2[((hsi*6+1)*lowdim+lsi)*1];
...
fp29 = 2.0000000000000000e+00 * src2[((hsi*6+2)*lowdim+lsi)*1];
...
fp45 = 2.0000000000000000e+00 * src2[((hsi*6+0)*lowdim+lsi)*1];
...
fp13 = 2.0000000000000000e+00 * src2[((hsi*6+4)*lowdim+lsi)*1];
...
fp5 = 2.0000000000000000e+00 * src2[((hsi*6+5)*lowdim+lsi)*1];
...
fp21 = 2.0000000000000000e+00 * src2[((hsi*6+3)*lowdim+lsi)*1];
