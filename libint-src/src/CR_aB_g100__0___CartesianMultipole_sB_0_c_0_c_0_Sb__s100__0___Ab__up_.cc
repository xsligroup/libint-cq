...
extern "C" {
#endif
void CR_aB_g100__0___CartesianMultipole_sB_0_c_0_c_0_Sb__s100__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp14 = 0.0000000000000000e+00 + src0[((hsi*12+7)*1+lsi)*1];
...
fp13 = 0.0000000000000000e+00 + src0[((hsi*12+9)*1+lsi)*1];
...
fp15 = 0.0000000000000000e+00 + src0[((hsi*12+11)*1+lsi)*1];
