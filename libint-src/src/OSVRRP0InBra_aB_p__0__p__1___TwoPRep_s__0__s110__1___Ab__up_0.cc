...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__p__1___TwoPRep_s__0__s110__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp11 = fp38 * src4[((hsi*3+2)*1+lsi)*1];
...
fp16 = fp38 * src4[((hsi*3+1)*1+lsi)*1];
...
fp22 = fp38 * src4[((hsi*3+0)*1+lsi)*1];
