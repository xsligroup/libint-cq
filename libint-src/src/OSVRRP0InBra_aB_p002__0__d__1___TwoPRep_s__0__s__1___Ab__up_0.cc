...
extern "C" {
#endif
void OSVRRP0InBra_aB_p002__0__d__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp68 = inteval->oo2ze[vi] * src2[((hsi*3+0)*1+lsi)*1];
...
fp60 = fp96 * src2[((hsi*3+1)*1+lsi)*1];
