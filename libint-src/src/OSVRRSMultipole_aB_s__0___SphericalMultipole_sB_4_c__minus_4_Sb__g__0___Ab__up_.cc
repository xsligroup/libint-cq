...
fp22 = inteval->PB_y[vi] * src0[((hsi*10+6)*1+lsi)*1];
...
fp27 = inteval->PB_z[vi] * src0[((hsi*10+5)*1+lsi)*1];
...
fp32 = inteval->PB_z[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp40 = inteval->PB_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
LIBINT2_REALTYPE fp34;
fp34 = fp40 + fp35;
target[((hsi*15+6)*1+lsi)*1] = fp34;
LIBINT2_REALTYPE fp44;
fp44 = 1.0000000000000000e+00 * src1[((hsi*6+0)*1+lsi)*1];
LIBINT2_REALTYPE fp43;
fp43 = 0.0000000000000000e+00 + fp44;
LIBINT2_REALTYPE fp42;
fp42 = inteval->oo2z[vi] * fp43;
LIBINT2_REALTYPE fp45;
fp45 = inteval->PB_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp53 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp58 = -5.0000000000000000e-01 * src3[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp57;
fp57 = 0.0000000000000000e+00 + fp58;
LIBINT2_REALTYPE fp56;
fp56 = inteval->oo2z[vi] * fp57;
LIBINT2_REALTYPE fp59;
fp59 = inteval->PB_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
