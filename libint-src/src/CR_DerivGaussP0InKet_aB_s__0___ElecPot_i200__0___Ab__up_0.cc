...
extern "C" {
#endif
void CR_DerivGaussP0InKet_aB_s__0___ElecPot_i200__0___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
