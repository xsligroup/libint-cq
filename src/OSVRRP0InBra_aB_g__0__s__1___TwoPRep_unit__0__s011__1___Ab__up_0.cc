...
extern "C" {
#endif
void OSVRRP0InBra_aB_g__0__s__1___TwoPRep_unit__0__s011__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp37 = inteval->roz[vi] * src2[((hsi*6+3)*1+lsi)*1];
...
fp39 = inteval->WP_y[vi] * src0[((hsi*10+6)*1+lsi)*1];
...
fp46 = inteval->roz[vi] * src2[((hsi*6+2)*1+lsi)*1];
...
fp48 = inteval->WP_z[vi] * src0[((hsi*10+5)*1+lsi)*1];
...
fp55 = inteval->roz[vi] * src2[((hsi*6+1)*1+lsi)*1];
...
fp57 = inteval->WP_z[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp61 = inteval->WP_z[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp70 = inteval->WP_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp79 = inteval->WP_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp83 = inteval->WP_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp90 = inteval->roz[vi] * src2[((hsi*6+0)*1+lsi)*1];
...
fp92 = inteval->WP_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp96 = inteval->WP_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp100 = inteval->WP_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp106 = inteval->WP_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
