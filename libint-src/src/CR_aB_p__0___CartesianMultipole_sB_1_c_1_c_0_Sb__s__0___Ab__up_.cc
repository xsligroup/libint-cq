...
extern "C" {
#endif
void CR_aB_p__0___CartesianMultipole_sB_1_c_1_c_0_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp2 = 0.0000000000000000e+00 + src1[((hsi*6+4)*1+lsi)*1];
