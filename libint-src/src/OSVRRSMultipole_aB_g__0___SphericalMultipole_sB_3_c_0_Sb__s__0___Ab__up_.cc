...
fp36 = inteval->PA_z[vi] * src0[((hsi*10+5)*1+lsi)*1];
...
fp42 = inteval->PA_z[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp46 = inteval->PA_z[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp60 = 1.0000000000000000e+00 * src1[((hsi*6+0)*1+lsi)*1];
...
fp65 = inteval->PA_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp73 = 1.0000000000000000e+00 * src1[((hsi*6+0)*1+lsi)*1];
...
fp78 = inteval->PA_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp84 = 5.0000000000000000e-01 * src3[((hsi*10+0)*1+lsi)*1];
...
fp85 = inteval->PA_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
