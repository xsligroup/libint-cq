...
extern "C" {
#endif
void HRRPart0bra0ket0p020p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp3 = 2.0000000000000000e+00 * src2[((hsi*3+2)*lowdim+lsi)*1];
...
fp11 = 2.0000000000000000e+00 * src2[((hsi*3+1)*lowdim+lsi)*1];
...
fp19 = 2.0000000000000000e+00 * src2[((hsi*3+0)*lowdim+lsi)*1];
