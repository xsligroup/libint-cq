...
extern "C" {
#endif
void _kineticderiv1_K_K(const Libint_t* inteval) {

_libint2_static_api_bzero_short_(inteval->stack+0*1,7776)
const int contrdepth = inteval->contrdepth;
#ifdef __INTEL_COMPILER
#pragma ivdep
#endif
for(int c = 0; c<contrdepth; c++) {
_kineticderiv1_K_K_prereq(inteval+c, inteval->stack);
}
