...
extern "C" {
#endif
void OSVRRP1InBra_aB_s110__0__f__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp31 = 1.0000000000000000e+00 * inteval->alpha1_over_zetapluseta[vi];
LIBINT2_REALTYPE fp10;
fp10 = fp31 * src4[((hsi*6+3)*1+lsi)*1];
...
fp20 = fp31 * src4[((hsi*6+1)*1+lsi)*1];
...
fp27 = fp31 * src4[((hsi*6+0)*1+lsi)*1];
...
fp37 = inteval->WQ_x[vi] * src0[((hsi*6+0)*1+lsi)*1];
