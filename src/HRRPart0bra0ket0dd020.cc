...
extern "C" {
#endif
void HRRPart0bra0ket0dd020(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp53 = 2.0000000000000000e+00 * src2[((hsi*18+7)*lowdim+lsi)*1];
...
fp59 = 2.0000000000000000e+00 * src2[((hsi*18+6)*lowdim+lsi)*1];
...
fp75 = 2.0000000000000000e+00 * src2[((hsi*18+3)*lowdim+lsi)*1];
...
fp85 = 2.0000000000000000e+00 * src2[((hsi*18+1)*lowdim+lsi)*1];
...
fp91 = 2.0000000000000000e+00 * src2[((hsi*18+0)*lowdim+lsi)*1];
...
fp69 = 2.0000000000000000e+00 * src2[((hsi*18+4)*lowdim+lsi)*1];
...
fp27 = 2.0000000000000000e+00 * src2[((hsi*18+12)*lowdim+lsi)*1];
...
fp37 = 2.0000000000000000e+00 * src2[((hsi*18+10)*lowdim+lsi)*1];
...
fp43 = 2.0000000000000000e+00 * src2[((hsi*18+9)*lowdim+lsi)*1];
...
fp21 = 2.0000000000000000e+00 * src2[((hsi*18+13)*lowdim+lsi)*1];
