...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_s__0__s020__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp89 = inteval->oo2ze[vi] * src2[((hsi*6+0)*1+lsi)*1];
...
fp71 = inteval->oo2ze[vi] * src2[((hsi*6+2)*1+lsi)*1];
...
fp59 = fp139 * src2[((hsi*6+3)*1+lsi)*1];
...
fp52 = fp133 * src2[((hsi*6+4)*1+lsi)*1];
