...
extern "C" {
#endif
void HRRPart1bra0ket0fp002(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp73 = 2.0000000000000000e+00 * src2[((hsi*10+0)*1+lsi)*1];
...
fp65 = 2.0000000000000000e+00 * src2[((hsi*10+1)*1+lsi)*1];
...
fp57 = 2.0000000000000000e+00 * src2[((hsi*10+2)*1+lsi)*1];
...
fp49 = 2.0000000000000000e+00 * src2[((hsi*10+3)*1+lsi)*1];
...
fp41 = 2.0000000000000000e+00 * src2[((hsi*10+4)*1+lsi)*1];
...
fp33 = 2.0000000000000000e+00 * src2[((hsi*10+5)*1+lsi)*1];
...
fp25 = 2.0000000000000000e+00 * src2[((hsi*10+6)*1+lsi)*1];
...
fp17 = 2.0000000000000000e+00 * src2[((hsi*10+7)*1+lsi)*1];
...
fp9 = 2.0000000000000000e+00 * src2[((hsi*10+8)*1+lsi)*1];
...
fp1 = 2.0000000000000000e+00 * src2[((hsi*10+9)*1+lsi)*1];
