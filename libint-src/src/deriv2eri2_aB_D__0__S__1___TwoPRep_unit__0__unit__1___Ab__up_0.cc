...
extern "C" {
#endif
void deriv2eri2_aB_D__0__S__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval) {
...
deriv2eri2_aB_D__0__S__1___TwoPRep_unit__0__unit__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
