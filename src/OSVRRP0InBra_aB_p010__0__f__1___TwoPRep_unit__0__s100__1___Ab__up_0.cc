...
extern "C" {
#endif
void OSVRRP0InBra_aB_p010__0__f__1___TwoPRep_unit__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp62 = fp94 * src1[((hsi*6+0)*1+lsi)*1];
...
fp47 = fp94 * src1[((hsi*6+2)*1+lsi)*1];
...
fp37 = fp112 * src1[((hsi*6+3)*1+lsi)*1];
...
fp31 = fp105 * src1[((hsi*6+4)*1+lsi)*1];
...
fp11 = fp94 * src1[((hsi*6+1)*1+lsi)*1];
