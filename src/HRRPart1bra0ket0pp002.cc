...
extern "C" {
#endif
void HRRPart1bra0ket0pp002(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp1 = 2.0000000000000000e+00 * src2[((hsi*3+2)*1+lsi)*1];
...
fp6 = src0[((hsi*6+2)*1+lsi)*1] + fp7;
target[((hsi*9+6)*1+lsi)*1] = fp6;
LIBINT2_REALTYPE fp9;
fp9 = 2.0000000000000000e+00 * src2[((hsi*3+1)*1+lsi)*1];
...
fp17 = 2.0000000000000000e+00 * src2[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp19;
fp19 = inteval->CD_z[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp18;
fp18 = src0[((hsi*6+2)*1+lsi)*1] + fp19;
...
fp20 = src0[((hsi*6+1)*1+lsi)*1] + fp21;
