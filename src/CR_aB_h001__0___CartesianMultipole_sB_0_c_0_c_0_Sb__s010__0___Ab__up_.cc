...
extern "C" {
#endif
void CR_aB_h001__0___CartesianMultipole_sB_0_c_0_c_0_Sb__s010__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp11 = 0.0000000000000000e+00 + src1[((hsi*14+3)*1+lsi)*1];
...
fp10 = 0.0000000000000000e+00 + src1[((hsi*14+5)*1+lsi)*1];
