...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__d__1___TwoPRep_s__0__s002__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp73 = inteval->oo2ze[vi] * src2[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp75;
fp75 = inteval->WP_x[vi] * src1[((hsi*6+1)*1+lsi)*1];
LIBINT2_REALTYPE fp76;
fp76 = inteval->PA_x[vi] * src0[((hsi*6+1)*1+lsi)*1];
...
fp68 = inteval->oo2ze[vi] * src2[((hsi*3+2)*1+lsi)*1];
...
fp51 = inteval->oo2ze[vi] * src2[((hsi*3+0)*1+lsi)*1];
...
fp31 = 2.0000000000000000e+00 * inteval->alpha4_over_zetapluseta[vi];
...
fp43 = fp79 * src2[((hsi*3+1)*1+lsi)*1];
