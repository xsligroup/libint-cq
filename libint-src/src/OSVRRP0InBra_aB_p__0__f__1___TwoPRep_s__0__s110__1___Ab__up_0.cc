...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_s__0__s110__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp94 = fp157 * src4[((hsi*10+0)*1+lsi)*1];
...
fp87 = fp157 * src4[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp89;
fp89 = fp136 * src2[((hsi*6+0)*1+lsi)*1];
...
fp82 = fp157 * src4[((hsi*10+2)*1+lsi)*1];
...
fp76 = fp157 * src4[((hsi*10+3)*1+lsi)*1];
...
fp69 = fp157 * src4[((hsi*10+4)*1+lsi)*1];
LIBINT2_REALTYPE fp71;
fp71 = fp136 * src2[((hsi*6+2)*1+lsi)*1];
...
fp57 = fp157 * src4[((hsi*10+6)*1+lsi)*1];
LIBINT2_REALTYPE fp59;
fp59 = fp160 * src2[((hsi*6+3)*1+lsi)*1];
...
fp50 = fp157 * src4[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp52;
fp52 = fp151 * src2[((hsi*6+4)*1+lsi)*1];
...
fp44 = fp157 * src4[((hsi*10+8)*1+lsi)*1];
...
fp39 = fp157 * src4[((hsi*10+9)*1+lsi)*1];
...
fp21 = fp136 * src2[((hsi*6+1)*1+lsi)*1];
...
fp1 = fp160 * src2[((hsi*6+5)*1+lsi)*1];
...
fp64 = fp157 * src4[((hsi*10+5)*1+lsi)*1];
