...
extern "C" {
#endif
void OSVRRP0InBra_aB_p101__0__f__1___TwoPRep_unit__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp65 = fp101 * src1[((hsi*6+0)*1+lsi)*1];
...
fp55 = fp121 * src1[((hsi*6+3)*1+lsi)*1];
...
fp52 = fp114 * src1[((hsi*6+4)*1+lsi)*1];
