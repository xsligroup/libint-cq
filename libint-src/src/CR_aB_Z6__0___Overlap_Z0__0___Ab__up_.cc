...
fp18 = inteval->PA_z[vi] * target[((hsi*7+1)*1+lsi)*1];
...
fp15 = inteval->PA_z[vi] * target[((hsi*7+2)*1+lsi)*1];
LIBINT2_REALTYPE fp12;
fp12 = fp15 + fp13;
target[((hsi*7+3)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
fp11 = inteval->PA_z[vi] * target[((hsi*7+3)*1+lsi)*1];
...
fp7 = inteval->PA_z[vi] * target[((hsi*7+4)*1+lsi)*1];
...
fp3 = inteval->PA_z[vi] * target[((hsi*7+5)*1+lsi)*1];
