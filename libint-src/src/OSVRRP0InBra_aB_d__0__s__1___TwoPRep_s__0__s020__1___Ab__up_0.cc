...
extern "C" {
#endif
void OSVRRP0InBra_aB_d__0__s__1___TwoPRep_s__0__s020__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp18 = 2.0000000000000000e+00 * inteval->alpha4_over_zetapluseta[vi];
...
fp27 = inteval->WP_x[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp28;
fp28 = inteval->PA_x[vi] * src0[((hsi*3+0)*1+lsi)*1];
