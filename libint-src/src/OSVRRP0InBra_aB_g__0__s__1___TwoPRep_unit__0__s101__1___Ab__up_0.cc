...
extern "C" {
#endif
void OSVRRP0InBra_aB_g__0__s__1___TwoPRep_unit__0__s101__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp95 = inteval->roz[vi] * src2[((hsi*6+0)*1+lsi)*1];
...
fp97 = inteval->WP_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
