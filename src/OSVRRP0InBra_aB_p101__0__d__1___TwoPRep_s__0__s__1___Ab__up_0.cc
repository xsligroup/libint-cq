...
extern "C" {
#endif
void OSVRRP0InBra_aB_p101__0__d__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5, const LIBINT2_REALTYPE* src6) {
...
fp68 = fp116 * src2[((hsi*3+0)*1+lsi)*1];
...
fp47 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+0)*1+lsi)*1];
...
fp39 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+1)*1+lsi)*1];
...
fp30 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+2)*1+lsi)*1];
...
fp22 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+3)*1+lsi)*1];
...
fp13 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+4)*1+lsi)*1];
...
fp3 = inteval->alpha1_rho_over_zeta2[vi] * src6[((hsi*6+5)*1+lsi)*1];
...
fp60 = fp127 * src2[((hsi*3+1)*1+lsi)*1];
