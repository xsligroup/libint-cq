...
extern "C" {
#endif
void OSVRRP0InBra_aB_d010__0__d__1___TwoPRep_unit__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5) {
...
fp66 = fp149 * src3[((hsi*9+2)*1+lsi)*1];
...
fp98 = fp138 * src3[((hsi*9+0)*1+lsi)*1];
...
fp88 = fp149 * src3[((hsi*9+1)*1+lsi)*1];
...
fp1 = fp149 * src3[((hsi*9+8)*1+lsi)*1];
...
fp5 = fp138 * src3[((hsi*9+7)*1+lsi)*1];
...
fp11 = fp138 * src3[((hsi*9+6)*1+lsi)*1];
...
fp19 = fp149 * src3[((hsi*9+5)*1+lsi)*1];
...
fp22 = fp138 * src3[((hsi*9+4)*1+lsi)*1];
...
fp57 = fp138 * src3[((hsi*9+3)*1+lsi)*1];
...
fp38 = fp138 * src3[((hsi*9+5)*1+lsi)*1];
...
fp45 = fp149 * src3[((hsi*9+4)*1+lsi)*1];
