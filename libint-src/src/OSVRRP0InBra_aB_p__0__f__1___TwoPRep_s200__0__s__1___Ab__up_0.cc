...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_s200__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp153 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+1)*1+lsi)*1];
...
fp143 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+2)*1+lsi)*1];
...
fp164 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+0)*1+lsi)*1];
