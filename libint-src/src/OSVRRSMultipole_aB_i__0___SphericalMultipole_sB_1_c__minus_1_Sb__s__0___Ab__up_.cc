...
fp119 = -5.0000000000000000e-01 * src2[((hsi*21+0)*1+lsi)*1];
LIBINT2_REALTYPE fp118;
fp118 = 0.0000000000000000e+00 + fp119;
LIBINT2_REALTYPE fp117;
fp117 = inteval->oo2z[vi] * fp118;
LIBINT2_REALTYPE fp120;
fp120 = inteval->PA_y[vi] * src0[((hsi*21+0)*1+lsi)*1];
...
fp114 = inteval->PA_y[vi] * src0[((hsi*21+1)*1+lsi)*1];
...
fp106 = inteval->PA_z[vi] * src0[((hsi*21+2)*1+lsi)*1];
...
fp101 = inteval->PA_y[vi] * src0[((hsi*21+3)*1+lsi)*1];
...
fp93 = inteval->PA_z[vi] * src0[((hsi*21+4)*1+lsi)*1];
...
fp88 = inteval->PA_z[vi] * src0[((hsi*21+5)*1+lsi)*1];
...
fp83 = inteval->PA_y[vi] * src0[((hsi*21+6)*1+lsi)*1];
...
fp75 = inteval->PA_z[vi] * src0[((hsi*21+7)*1+lsi)*1];
...
fp70 = inteval->PA_z[vi] * src0[((hsi*21+8)*1+lsi)*1];
...
fp60 = inteval->PA_y[vi] * src0[((hsi*21+10)*1+lsi)*1];
...
fp52 = inteval->PA_z[vi] * src0[((hsi*21+11)*1+lsi)*1];
...
fp47 = inteval->PA_z[vi] * src0[((hsi*21+12)*1+lsi)*1];
...
fp32 = inteval->PA_y[vi] * src0[((hsi*21+15)*1+lsi)*1];
