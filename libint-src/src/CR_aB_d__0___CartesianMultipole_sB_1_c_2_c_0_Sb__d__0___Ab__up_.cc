...
fp83 = 0.0000000000000000e+00 + src0[((hsi*18+8)*1+lsi)*1];
...
fp82 = 0.0000000000000000e+00 + src0[((hsi*18+9)*1+lsi)*1];
...
fp38 = 0.0000000000000000e+00 + src1[((hsi*18+8)*1+lsi)*1];
...
fp73 = 0.0000000000000000e+00 + src0[((hsi*18+2)*1+lsi)*1];
...
fp72 = 0.0000000000000000e+00 + src0[((hsi*18+3)*1+lsi)*1];
