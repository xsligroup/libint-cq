...
fp22 = inteval->PA_z[vi] * target[((hsi*8+1)*1+lsi)*1];
LIBINT2_REALTYPE fp20;
fp20 = fp22 + fp21;
target[((hsi*8+2)*1+lsi)*1] = fp20;
LIBINT2_REALTYPE fp19;
fp19 = inteval->PA_z[vi] * target[((hsi*8+2)*1+lsi)*1];
...
fp15 = inteval->PA_z[vi] * target[((hsi*8+3)*1+lsi)*1];
LIBINT2_REALTYPE fp12;
fp12 = fp15 + fp13;
target[((hsi*8+4)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
fp11 = inteval->PA_z[vi] * target[((hsi*8+4)*1+lsi)*1];
...
fp7 = inteval->PA_z[vi] * target[((hsi*8+5)*1+lsi)*1];
...
fp3 = inteval->PA_z[vi] * target[((hsi*8+6)*1+lsi)*1];
