...
extern "C" {
#endif
void HRRPart1bra0ket0p020p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp3 = 2.0000000000000000e+00 * src2[((hsi*3+2)*1+lsi)*1];
...
fp8 = src0[((hsi*6+4)*1+lsi)*1] + fp9;
target[((hsi*9+5)*1+lsi)*1] = fp8;
LIBINT2_REALTYPE fp11;
fp11 = 2.0000000000000000e+00 * src2[((hsi*3+1)*1+lsi)*1];
...
fp16 = src0[((hsi*6+2)*1+lsi)*1] + fp17;
target[((hsi*9+2)*1+lsi)*1] = fp16;
LIBINT2_REALTYPE fp19;
fp19 = 2.0000000000000000e+00 * src2[((hsi*3+0)*1+lsi)*1];
