...
extern "C" {
#endif
void OSVRRP0InBra_aB_p100__0__f__1___TwoPRep_unit__0__s001__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp56 = fp92 * src1[((hsi*6+0)*1+lsi)*1];
...
fp50 = fp92 * src1[((hsi*6+2)*1+lsi)*1];
...
fp46 = fp112 * src1[((hsi*6+3)*1+lsi)*1];
...
fp43 = fp105 * src1[((hsi*6+4)*1+lsi)*1];
...
fp23 = fp92 * src1[((hsi*6+1)*1+lsi)*1];
