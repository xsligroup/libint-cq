...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_unit__0__s110__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp56 = fp99 * src3[((hsi*10+0)*1+lsi)*1];
...
fp51 = fp99 * src3[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp53;
fp53 = fp84 * src1[((hsi*6+0)*1+lsi)*1];
...
fp48 = fp99 * src3[((hsi*10+2)*1+lsi)*1];
...
fp44 = fp99 * src3[((hsi*10+3)*1+lsi)*1];
...
fp39 = fp99 * src3[((hsi*10+4)*1+lsi)*1];
LIBINT2_REALTYPE fp41;
fp41 = fp84 * src1[((hsi*6+2)*1+lsi)*1];
...
fp31 = fp99 * src3[((hsi*10+6)*1+lsi)*1];
LIBINT2_REALTYPE fp33;
fp33 = fp102 * src1[((hsi*6+3)*1+lsi)*1];
...
fp26 = fp99 * src3[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp28;
fp28 = fp95 * src1[((hsi*6+4)*1+lsi)*1];
...
fp22 = fp99 * src3[((hsi*10+8)*1+lsi)*1];
...
fp19 = fp99 * src3[((hsi*10+9)*1+lsi)*1];
...
fp11 = fp84 * src1[((hsi*6+1)*1+lsi)*1];
...
fp1 = fp102 * src1[((hsi*6+5)*1+lsi)*1];
...
fp36 = fp99 * src3[((hsi*10+5)*1+lsi)*1];
