...
extern "C" {
#endif
void OSVRRP0InBra_aB_p001__0__d__1___TwoPRep_unit__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp36 = fp57 * src1[((hsi*3+0)*1+lsi)*1];
...
fp32 = fp64 * src1[((hsi*3+1)*1+lsi)*1];
