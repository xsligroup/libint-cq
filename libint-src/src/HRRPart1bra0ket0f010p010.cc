...
extern "C" {
#endif
void HRRPart1bra0ket0f010p010(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, int highdim) {
...
fp93 = 1.0000000000000000e+00 * src3[((hsi*10+0)*1+lsi)*1];
...
fp83 = 1.0000000000000000e+00 * src3[((hsi*10+1)*1+lsi)*1];
...
fp73 = 1.0000000000000000e+00 * src3[((hsi*10+2)*1+lsi)*1];
...
fp63 = 1.0000000000000000e+00 * src3[((hsi*10+3)*1+lsi)*1];
...
fp53 = 1.0000000000000000e+00 * src3[((hsi*10+4)*1+lsi)*1];
...
fp43 = 1.0000000000000000e+00 * src3[((hsi*10+5)*1+lsi)*1];
...
fp33 = 1.0000000000000000e+00 * src3[((hsi*10+6)*1+lsi)*1];
...
fp23 = 1.0000000000000000e+00 * src3[((hsi*10+7)*1+lsi)*1];
...
fp13 = 1.0000000000000000e+00 * src3[((hsi*10+8)*1+lsi)*1];
...
fp3 = 1.0000000000000000e+00 * src3[((hsi*10+9)*1+lsi)*1];
