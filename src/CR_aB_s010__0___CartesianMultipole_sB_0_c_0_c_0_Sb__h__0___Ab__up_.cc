...
extern "C" {
#endif
void CR_aB_s010__0___CartesianMultipole_sB_0_c_0_c_0_Sb__h__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp16 = 0.0000000000000000e+00 + src0[((hsi*12+4)*1+lsi)*1];
...
fp15 = 0.0000000000000000e+00 + src0[((hsi*12+3)*1+lsi)*1];
...
fp14 = 0.0000000000000000e+00 + src0[((hsi*12+2)*1+lsi)*1];
