...
extern "C" {
#endif
void OSVRRP1InBra_aB_f__0__p__1___TwoPRep_unit__0__s002__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp164 = inteval->WQ_y[vi] * src1[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp165;
fp165 = inteval->QC_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp163;
fp163 = fp165 + fp164;
target[((hsi*30+1)*1+lsi)*1] = fp163;
LIBINT2_REALTYPE fp158;
fp158 = inteval->alpha4_rho_over_eta2[vi] * src4[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp159;
fp159 = inteval->rho34_over_alpha3[vi] * src3[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp157;
fp157 = fp159 - fp158;
LIBINT2_REALTYPE fp156;
fp156 = 2.0000000000000000e+00 * fp157;
LIBINT2_REALTYPE fp161;
fp161 = inteval->WQ_z[vi] * src1[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp162;
fp162 = inteval->QC_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp145 = inteval->oo2ze[vi] * src2[((hsi*6+0)*1+lsi)*1];
LIBINT2_REALTYPE fp147;
fp147 = inteval->WQ_y[vi] * src1[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp148;
fp148 = inteval->QC_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp137 = 2.0000000000000000e+00 * fp138;
...
fp120 = 2.0000000000000000e+00 * fp121;
...
fp93 = inteval->oo2ze[vi] * src2[((hsi*6+2)*1+lsi)*1];
...
fp83 = 2.0000000000000000e+00 * fp84;
LIBINT2_REALTYPE fp88;
fp88 = inteval->oo2ze[vi] * src2[((hsi*6+1)*1+lsi)*1];
...
fp58 = fp168 * src2[((hsi*6+3)*1+lsi)*1];
...
fp50 = 2.0000000000000000e+00 * fp51;
...
fp42 = fp151 * src2[((hsi*6+4)*1+lsi)*1];
...
fp33 = 2.0000000000000000e+00 * fp34;
...
fp17 = 2.0000000000000000e+00 * fp18;
