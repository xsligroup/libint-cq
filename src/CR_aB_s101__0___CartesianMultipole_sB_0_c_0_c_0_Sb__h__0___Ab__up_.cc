...
extern "C" {
#endif
void CR_aB_s101__0___CartesianMultipole_sB_0_c_0_c_0_Sb__h__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp10 = 0.0000000000000000e+00 + src1[((hsi*18+1)*1+lsi)*1];
...
fp9 = 0.0000000000000000e+00 + src1[((hsi*18+2)*1+lsi)*1];
...
fp8 = 0.0000000000000000e+00 + src1[((hsi*18+3)*1+lsi)*1];
...
fp7 = 0.0000000000000000e+00 + src1[((hsi*18+4)*1+lsi)*1];
